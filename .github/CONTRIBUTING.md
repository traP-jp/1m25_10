...
- (ルールに従っていない場合、ブランチの公開が拒否されます。)
  - ルールに登録されてる fnmatch の詳細
    - `feature/[0-9]-[a-z0-9-][a-z0-9-]*`
    - `feature/[0-9][0-9]*-[a-z0-9-][a-z0-9-]*`
    - `fix/[0-9]-[a-z0-9-][a-z0-9-]*`
    - `fix/[0-9][0-9]*-[a-z0-9-][a-z0-9-]*`
    - `refactor/[0-9]-[a-z0-9-][a-z0-9-]*`
    - `refactor/[0-9][0-9]*-[a-z0-9-][a-z0-9-]*`
    - `docs/[0-9]-[a-z0-9-][a-z0-9-]*`
    - `docs/[0-9][0-9]*-[a-z0-9-][a-z0-9-]*`
    - `chore/[0-9]-[a-z0-9-][a-z0-9-]*`
    - `chore/[0-9][0-9]*-[a-z0-9-][a-z0-9-]*`
    - `assets/[0-9]-[a-z0-9-][a-z0-9-]*`
    - `assets/[0-9][0-9]*-[a-z0-9-][a-z0-9-]*`
